window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:C:\Users\Administrator\Desktop\Project\deepseek-harness-desktop\plugins\dsh-codex-timeline\src\client\Timeline.module.css.mjs
		const css = ".UtsUdG_root{display:inline-flex}.UtsUdG_portal{pointer-events:none;z-index:940;position:fixed;inset:0}.UtsUdG_railShell{pointer-events:auto;animation:.15s cubic-bezier(.23,1,.32,1) UtsUdG_rail-in;position:fixed;transform:translateY(-50%)}@keyframes UtsUdG_rail-in{0%{opacity:0}to{opacity:1}}.UtsUdG_rail{--edge-fade-distance:40px;-ms-overflow-style:none;mask-image:linear-gradient(to bottom, transparent, #000 var(--edge-fade-distance), #000 calc(100% - var(--edge-fade-distance)), transparent);overscroll-behavior:contain;scrollbar-width:none;max-width:36px;overflow:hidden auto}.UtsUdG_rail::-webkit-scrollbar{display:none}.UtsUdG_markerList{flex-direction:column;display:flex}.UtsUdG_markerButton{cursor:pointer;background:0 0;border:0;outline:none;flex:0 0 10px;align-items:center;width:36px;height:10px;padding:0;display:flex}.UtsUdG_markerSlot{align-items:center;width:30px;height:2px;display:flex}.UtsUdG_marker{--marker-progress:0;background-color:var(--dsw-alias-label-secondary,#aeb2bb);opacity:.4;height:2px;transform:scaleX(calc(.2308 + .7692 * var(--marker-progress)));transform-origin:0;transition:transform .16s linear(0, .398 10%, .682 20%, .843 30%, .925 40%, .972 50%, 1.004 60%, 1.008 70%, 1.003 80%, 1);width:26px;display:block}.UtsUdG_markerButton[aria-current=true] .UtsUdG_marker{background-color:var(--dsw-alias-label-primary,#f0f2f6);opacity:.6}.UtsUdG_markerButton:has(+.UtsUdG_markerButton[data-scrub-target]) .UtsUdG_marker,.UtsUdG_markerButton[data-scrub-target]+.UtsUdG_markerButton .UtsUdG_marker{--marker-progress:.7}.UtsUdG_markerButton:has(+.UtsUdG_markerButton+.UtsUdG_markerButton[data-scrub-target]) .UtsUdG_marker,.UtsUdG_markerButton[data-scrub-target]+.UtsUdG_markerButton+.UtsUdG_markerButton .UtsUdG_marker{--marker-progress:.4}.UtsUdG_markerButton:has(+.UtsUdG_markerButton+.UtsUdG_markerButton+.UtsUdG_markerButton[data-scrub-target]) .UtsUdG_marker,.UtsUdG_markerButton[data-scrub-target]+.UtsUdG_markerButton+.UtsUdG_markerButton+.UtsUdG_markerButton .UtsUdG_marker{--marker-progress:.2}.UtsUdG_markerButton:focus-visible .UtsUdG_marker,.UtsUdG_markerButton[data-scrub-target] .UtsUdG_marker{--marker-progress:1;background-color:var(--dsw-alias-label-primary,#f0f2f6);opacity:1}.UtsUdG_rail[data-scrubbing] .UtsUdG_marker{transition-duration:0s}.UtsUdG_rail[data-scrubbing] .UtsUdG_markerButton[aria-current=true]:not([data-scrub-target]) .UtsUdG_marker{background-color:var(--dsw-alias-label-secondary,#aeb2bb);opacity:.4}@media (hover:hover){.UtsUdG_rail:not([data-scrubbing]):hover .UtsUdG_markerButton[aria-current=true]:not(:hover):not(:focus-visible) .UtsUdG_marker{background-color:var(--dsw-alias-label-secondary,#aeb2bb);opacity:.4}.UtsUdG_rail:not([data-scrubbing]):hover .UtsUdG_markerButton:has(+.UtsUdG_markerButton:hover) .UtsUdG_marker,.UtsUdG_rail:not([data-scrubbing]):hover .UtsUdG_markerButton:hover+.UtsUdG_markerButton .UtsUdG_marker{--marker-progress:.7}.UtsUdG_rail:not([data-scrubbing]):hover .UtsUdG_markerButton:has(+.UtsUdG_markerButton+.UtsUdG_markerButton:hover) .UtsUdG_marker,.UtsUdG_rail:not([data-scrubbing]):hover .UtsUdG_markerButton:hover+.UtsUdG_markerButton+.UtsUdG_markerButton .UtsUdG_marker{--marker-progress:.4}.UtsUdG_rail:not([data-scrubbing]):hover .UtsUdG_markerButton:has(+.UtsUdG_markerButton+.UtsUdG_markerButton+.UtsUdG_markerButton:hover) .UtsUdG_marker,.UtsUdG_rail:not([data-scrubbing]):hover .UtsUdG_markerButton:hover+.UtsUdG_markerButton+.UtsUdG_markerButton+.UtsUdG_markerButton .UtsUdG_marker{--marker-progress:.2}.UtsUdG_rail:not([data-scrubbing]):hover .UtsUdG_markerButton:hover .UtsUdG_marker{--marker-progress:1;background-color:var(--dsw-alias-label-primary,#f0f2f6);opacity:1}}.UtsUdG_preview{backdrop-filter:blur(4px);background:color-mix(in srgb, var(--dsw-alias-surface-elevated-secondary,#323337) 95%, transparent);box-sizing:border-box;color:var(--dsw-alias-label-primary,#f0f2f6);pointer-events:none;border:0;border-radius:12px;width:320px;max-width:calc(100vw - 16px);padding:8px;transition:top 80ms cubic-bezier(.23,1,.32,1);animation:.12s cubic-bezier(.23,1,.32,1) UtsUdG_preview-in;position:fixed;overflow:hidden;box-shadow:0 12px 36px #00000059,0 2px 8px #00000038}@keyframes UtsUdG_preview-in{0%{opacity:0;transform:translate(-3px)scale(.99)}to{opacity:1;transform:translate(0)scale(1)}}.UtsUdG_previewTitle{text-overflow:ellipsis;white-space:nowrap;align-items:center;gap:6px;min-width:0;font-size:14px;font-weight:600;line-height:20px;display:flex;overflow:hidden}.UtsUdG_previewText{color:var(--dsw-alias-label-secondary,#b9bdc6);-webkit-line-clamp:3;-webkit-box-orient:vertical;max-height:60px;margin:4px 0 0;font-size:14px;line-height:20px;display:-webkit-box;overflow:hidden}@media (prefers-reduced-motion:reduce){.UtsUdG_marker,.UtsUdG_preview,.UtsUdG_railShell{transition-duration:0s;animation-duration:0s}}";
		...
		var Timeline_module_css_default = {
			"portal": "UtsUdG_portal",
			"marker": "UtsUdG_marker",
			"markerSlot": "UtsUdG_markerSlot",
			"preview-in": "UtsUdG_preview-in",
			"root": "UtsUdG_root",
			"preview": "UtsUdG_preview",
			"previewText": "UtsUdG_previewText",
			"previewTitle": "UtsUdG_previewTitle",
			"markerButton": "UtsUdG_markerButton",
			"railShell": "UtsUdG_railShell",
			"markerList": "UtsUdG_markerList",
			"rail-in": "UtsUdG_rail-in",
			"rail": "UtsUdG_rail"
		};
		//#endregion
		...
		function Timeline({ t }) {
			...
			const scrollToMarker = (marker, behavior) => {
				...
				if (scrollport !== null) {
					...
					scrollport.scrollTo({
						top: Math.max(0, rowTop - scrollport.clientHeight / 3),
						behavior
					});
